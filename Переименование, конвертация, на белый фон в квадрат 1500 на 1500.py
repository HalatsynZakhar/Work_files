...
if __name__ == "__main__":
    ...
    article = None                # !!! ВАШ артикул або None
    ...
    # Якщо папка збереження дорівнює папці джерела - встановлювати False (файли заміняються)
    ...
    tolerance_for_white = 0                # !!! Число 0-255 або None
    ...
    perimeter_check_margin_pixels = 1       # !!! 0 або більше

    # Відсоток полів, що додаються, ЯКЩО perimeter_check_margin > 0 і периметр визнано білим.
    # Встановіть 0.0, щоб ВИМКНУТИ додавання полів, навіть якщо умова виконана. Поля в процентах
